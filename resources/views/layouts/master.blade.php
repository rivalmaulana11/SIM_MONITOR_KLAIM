...
<html lang="en">
  ...
  <head>
    ...
    {{-- <link rel="preload" href="{{ asset('AdminLTE-master/dist/css/adminlte.css') }}" as="style"> --}}
    ...
    <link
      rel="stylesheet"
      href="https:{{ asset('AdminLTE-master/dist/css/adminlte.css') }/cdn.jsdelivr.net/npm/jsvectormap@1.5.3/dist/css/jsvectormap.min.css"
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script src="public/AdminLTE-master/js/adminlte.js"></script>
